...
import {
  criarLancamentoEscritorio, mudarStatusLancamentoEscritorio, excluirLancamentoEscritorio,
  criarContaEscritorio, criarCategoriaEscritorio,
} from './acoes';
...
export default async function FinanceiroEscritorio() {
  ...
  if (!perfil?.org_id || !(await temFeature(sb, 'financeiro'))) {
    return (
      <PrecisaUpgrade
