...
export const NAVEGACAO_CONSULTOR: GrupoNav[] = [
  ...
  },
  {
    titulo: 'Gestão',
    itens: [
      { href: '/app/financeiro-escritorio', rotulo: 'Financeiro do escritório', icone: IconeFinanceiro, embreve: true },
      ...
      { href: '/app/config', rotulo: 'Configurações', icone: IconeConfig, embreve: true },
    ],
  },
];
